...
BEGIN Epoch
    ...
    Epoch        7 Apr 2022 04:00:00.000000000
    SmartEpoch
	BEGIN	EVENT
			Epoch	7 Apr 2022 04:00:00.000000000
			EventEpoch
...
Start                   7 Apr 2022 04:00:00.000000000
Stop                    8 Apr 2022 04:00:00.000000000
    SmartInterval
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	7 Apr 2022 04:00:00.000000000
...
BEGIN Intervals
    ...
    "7 Apr 2022 04:00:00.000000000" "8 Apr 2022 04:00:00.000000000"
END Intervals
...
END IntervalList
    ...
    BEGIN Report
        ...
        Style    Access
        AGIViewer    Yes
        Instance    Satellite/SAM/Sensor/SEN
        BEGIN InstanceList
            Instance    Target/TAR
        END InstanceList
        BEGIN TimeData
...
BEGIN Animation
    ...
    StartTime          7 Apr 2022 04:00:00.000000000
    EndTime            8 Apr 2022 04:00:00.000000000
    CurrentTime        7 Apr 2022 04:08:30.000000000
    Direction          Reverse
...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN MapAttributes
            PrimaryBody          Earth
            SecondaryBody        Sun
            CenterLatitude       1.410213
            CenterLongitude      111.419639

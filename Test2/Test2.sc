...
BEGIN Epoch
    ...
    Epoch        10 Apr 2022 04:00:00.000000000
    SmartEpoch
	BEGIN	EVENT
			Epoch	10 Apr 2022 04:00:00.000000000
			EventEpoch
...
Start                   10 Apr 2022 04:00:00.000000000
Stop                    10 Apr 2022 14:00:00.000000000
    SmartInterval
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	10 Apr 2022 04:00:00.000000000
...
BEGIN Extensions
	...
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	10 Apr 2022 04:00:00.000000000
				Stop	11 Apr 2022 04:00:00.000000000
			END Interval
			IntervalState	Explicit
	END	EVENTINTERVAL
...
BEGIN Animation
    ...
    StartTime          10 Apr 2022 04:00:00.000000000
    EndTime            10 Apr 2022 14:00:00.000000000
    CurrentTime        10 Apr 2022 04:00:00.000000000
    Direction          Forward
...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN MapAttributes
            PrimaryBody          Earth
            SecondaryBody        Sun
            CenterLatitude       19.300541
            CenterLongitude      131.906488
            ...
            BEGIN ZoomLocations
                BEGIN ZoomLocation
                    CenterLat    19.300541
                    CenterLon    131.906488
                    ZoomWidth    74.120808
                    ZoomHeight   58.651292
                End ZoomLocation
            END ZoomLocations
        ...
        BEGIN SoftVTR
            OutputFormat     WMV
            Directory        F:\00STKFile\新建文件夹\Test2
            BaseName         Frame
            Digits           4
            Frame            0

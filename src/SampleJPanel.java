...
extends JPanel
{
	...
	public final static String	s_STEP_1			= "Satellite Data Display";
	public final static String	s_STEP_2			= "Access";
	public final static String	s_STEP_3			= "Data Transmission And Feedbace";
	public final static String	s_STEP_4			= "Reset";
...
//		this.add(this.m_stepTwentyOneButton);
	...
	public void reset()
	{
		...
		this.getStepFour().setEnabled(true);

...
implements ActionListener, IAgAnimationJToolBarEventsListener
{
	...
	throws Throwable
	{
		...
		this.m_SampleCode = new SampleCode(this.m_AgStkObjectRootClass, m_test);
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		try
		{
			...
			if(command.equalsIgnoreCase(SampleJPanel.s_STEP_1))
			{
				...
				this.m_SampleCode.sateliteDataDisplay();
			...
			{
				this.m_SampleCode.dataTransmissionAndFeedback();
